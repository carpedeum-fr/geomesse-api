 ...
 */
class Version20170117153428 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE client ADD user_id INT DEFAULT NULL, ADD name VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE client DROP user_id, DROP name');
    }
}
